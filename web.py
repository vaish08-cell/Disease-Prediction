...
st.set_page_config(page_title='Prediction ',
                   layout='wide',
                   page_icon="🧑‍⚕️")
diabetes_model=pickle.load(open(r"C:\Users\HP\disease prediction\training_modules\diabetes_model.sav",'rb'))
heart_disease_model=pickle.load(open(r"C:\Users\HP\disease prediction\training_modules\heart_model.sav",'rb'))
parkinson_model=pickle.load(open(r"C:\Users\HP\disease prediction\training_modules\parkinson.sav",'rb'))
